...
def api_sales(
    ...
    return _events_report("sales", farm, event_from, event_to, db)
...
def api_deaths(
    ...
    return _events_report("deaths", farm, event_from, event_to, db)
...
def api_disease(
    ...
    return _events_report("disease", farm, event_from, event_to, db)
...
def api_breedings(
    ...
    return _events_report("breedings", farm, event_from, event_to, db)
