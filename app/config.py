...
# Cattle sale remittance PDFs (Eurofarm / Pathway / Buitelaar / Game Changer / Pickstock).
...
CATTLE_SALES_SENDER_DOMAIN = os.getenv(
    ...
    "eurofarmwales.co.uk,pathwayfarming.co.uk,buit.ie,gamechangerfarming.com,pickstocktelford.co.uk",
).strip().lower().lstrip("@")
